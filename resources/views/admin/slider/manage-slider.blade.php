                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($slider->publication_status==1)
                                            <a href="{{ route('status.slider',['id'=>$slider->id])}}" class="btn btn-success" title="Unpublished">
                                                <i data-feather="arrow-up-circle" class="icon-xl"></i>
                                            </a>
                                        @else
                                            <a href="{{ route('status.slider',['id'=>$slider->id])}}" class="btn btn-success" title="Published">
                                                <i data-feather="arrow-down-circle" class="icon-xl"></i>
                                            </a>
                                        @endif

                                        <a href="{{ route('edit.slider',['id'=>$slider->id])}}" class="btn btn-info">
                                            <i data-feather="edit" class="icon-xl"></i>
                                        </a>
                                        <a href="#" data-link="{{route('delete.slider',['id'=>$slider->id])}}" class="btn btn-danger delete">
