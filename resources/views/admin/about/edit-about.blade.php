                ...
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('update.about') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="hidden" name="id" value="{{ $about->id }}" id="" placeholder="Title">
                                <input type="text" name="title" value="{{ $about->title }}" class="form-control" id="exampleInputUsername2" placeholder="Title">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="url" class="form-control" value="{{ $about->url }}"  id="exampleInputUsername2" placeholder="Url">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <img id="img" src="{{asset($about->image)}}" alt="" style="height: 50px; width: 50px">
                            </div>
                        </div>
                        <div class="form-group row">
