        ...
        <div class="col-md-12 col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('add.about.us') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="url" class="form-control" id="exampleInputUsername2" placeholder="Url">
                            </div>
                        </div>
                        <div class="form-group row">
